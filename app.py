...
if final_area_score >= 2.0: c1.error(m_10); c2.error(m_30); c3.error(m_60)
elif final_area_score >= 1.0: c1.error(m_10); c2.error(m_30); c3.error(m_60)
elif final_area_score >= 0.2: c1.warning(m_10); c2.warning(m_30); c3.warning(m_60)
